...
namespace ShipABox.Clerk.TrackingNumberProvider
{
    internal class Program
    {
         ...
         *
         *  -   Simulates a clerk providing a tracking number, based on the
         *      customer's payment being completed as previously determined by
         *      another microservice.
         *
         *  -   This microservice responds to events of type
         *      ICustomerPayedInvoiceEvent by subscribing a consumer class of
         *      type CustomerPayedInvoiceConsumer. See the consumer class for
         *      the details.
         *
         *  -   The last step in the consumer class's consume method is to
         *      publish an event of type IClerkProvidedTrackingNumberEvent,
